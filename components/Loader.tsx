  ...
  return (
    <StyledWrapper>
      <svg xmlns="http://www.w3.org/2000/svg" height={200} width={200}>
        <g style={{order: -1}}>
          <polygon transform="rotate(45 100 100)" strokeWidth={1} stroke="#FFFE88" fill="none" points="70,70 148,50 130,130 50,150" id="bounce" />
          <polygon transform="rotate(45 100 100)" strokeWidth={1} stroke="#FFFE88" fill="none" points="70,70 148,50 130,130 50,150" id="bounce2" />
          <polygon transform="rotate(45 100 100)" strokeWidth={2} stroke="none" fill="#474747" points="70,70 150,50 130,130 50,150" />
          ...
          <polygon transform="translate(20, 31)" strokeWidth={2} stroke="none" fill="#C2C145" points="80,50 80,75 80,99 40,75" />
          ...
          <polygon transform="rotate(180 100 100) translate(20, 20)" strokeWidth={2} stroke="none" fill="#FBFA65" points="80,50 80,75 80,99 40,75" />
          ...
          <defs>
            <linearGradient y2="100%" x2="10%" y1="0%" x1="0%" id="gradiente3">
              <stop style={{stopColor: '#d3a51000', stopOpacity: 1}} offset="20%" />
              <stop style={{stopColor: '#FFFE88', stopOpacity: 1}} offset="100%" id="animatedStop" />
            </linearGradient>
          </defs>
          ...
          <polygon strokeWidth={2} stroke="none" fill="#3B393A" points="29.5,99.8 100,142 100,172 29.5,130" />
          <polygon transform="translate(50, 92)" strokeWidth={2} stroke="none" fill="#3B393A" points="50,50 120.5,8 120.5,35 50,80" />
        </g>
      </svg>
    </StyledWrapper>
  );
...
const StyledWrapper = styled.div`
  ...
  @keyframes umbral {
    0% {
      stop-color: rgba(255, 254, 136, 0.09);
    }
    50% {
      stop-color: rgba(255, 254, 136, 0.54);
    }
    100% {
      stop-color: rgba(255, 254, 136, 1);
    }
  }
  @keyframes partciles {
    0%,
